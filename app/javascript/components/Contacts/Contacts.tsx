            ...
            ReactDOM.render(
                <div style={{ margin: '5px' }}>
                    ...
                    <div id="buttonContainer2" style={{ float: 'left', marginLeft: '5px' }}>
                        <JqxButton onClick={addMultipleRowsClick} width={170} value={'Add Multiple New Rows'} />
                    </div>
                    <div id="buttonContainer3" style={{ float: 'left', marginLeft: '5px' }}>
                        <JqxButton onClick={deleteRowClick} width={150} value={'Delete Selected Row'} />
                    </div>
                    <div id="buttonContainer4" style={{ float: 'left', marginLeft: '5px' }}>
                        <JqxButton onClick={updateRowClick} width={155} value={'Update Selected Row'} />
                    </div>
                </div>,
                toolbar[0]
            );
    ...
    public render() {
        return (
            <JqxGrid ref={this.myGrid}
                ...
                // @ts-ignore
                width={getWidth('grid')} height={350} source={this.state.source} columns={this.state.columns}
